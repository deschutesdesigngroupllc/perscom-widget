...
export function Header({ currentMonth, previousMonth, goToToday, nextMonth }) {
  return (
    <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-600 lg:flex-none">
      <div className="text-xs font-bold uppercase text-gray-700 dark:text-gray-400">
      ...
      <div className="flex items-center">
        <div className="relative flex items-center rounded-md bg-white shadow-sm dark:bg-gray-800 md:items-stretch">
          ...
          <button
            type="button"
            className="hidden border-y border-gray-300 px-3.5 text-sm font-semibold text-gray-900 hover:bg-gray-50 focus:relative dark:border-gray-900 dark:text-gray-400 dark:hover:bg-gray-900 md:block"
            onClick={() => goToToday()}
          >
            Today
          </button>
          <span className="relative -mx-px h-5 w-px bg-gray-300 dark:bg-gray-900 md:hidden" />
          <button
            type="button"
